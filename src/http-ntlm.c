              ...
              DES_key_schedule DESKEYARG(ks))
{
  ...
  key.bytes[1] = ((key_56[0] << 7) & 0xFF) | (key_56[1] >> 1);
  key.bytes[2] = ((key_56[1] << 6) & 0xFF) | (key_56[2] >> 2);
  key.bytes[3] = ((key_56[2] << 5) & 0xFF) | (key_56[3] >> 3);
  key.bytes[4] = ((key_56[3] << 4) & 0xFF) | (key_56[4] >> 4);
  key.bytes[5] = ((key_56[4] << 3) & 0xFF) | (key_56[5] >> 5);
  key.bytes[6] = ((key_56[5] << 2) & 0xFF) | (key_56[6] >> 6);
  key.bytes[7] =  (key_56[6] << 1) & 0xFF;
